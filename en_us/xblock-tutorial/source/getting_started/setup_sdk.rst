...
**Note:** Make sure that you have performed **Step 4** of **Section 3.2.3**, and are now in the ``xblock_development`` directory. This directory contains the ``venv`` and ``xblock-sdk`` directories.
